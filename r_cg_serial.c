...
void R_SAU1_Create(void)
{
    ...
    NOP();
    NOP();
    SPS1 = _0004_SAU_CK00_FCLK_4 | _0000_SAU_CK01_FCLK_0;
    R_UART3_Create();
}
...
void R_UART3_Create(void)
{
    ...
    ST1 |= _0004_SAU_CH2_STOP_TRG_ON;    /* UART3 transmit disable */
...
void R_UART3_Start(void)
{
    ...
    SOE1 |= _0004_SAU_CH2_OUTPUT_ENABLE;    /* enable UART3 output */
    SS1 |= _0004_SAU_CH2_START_TRG_ON;    /* enable UART3 transmit */
    STIF3 = 0U;    /* clear INTST3 interrupt flag */
